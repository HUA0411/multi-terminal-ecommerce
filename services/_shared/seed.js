...
export function seedData() {
  ...
  const t = (obj) => obj;
  const translations = [
    { lang: "zh-CN", data: t({ home: "首页", categories: "分类", cart: "购物车", mine: "我的", allProducts: "全部商品", favorites: "收藏", search: "搜索", login: "登录", register: "注册", logout: "退出登录", addToCart: "加入购物车", buyNow: "立即购买", checkout: "去结算", pay: "去支付", paySuccess: "支付成功", orders: "我的订单", allOrders: "全部订单", pendingPayment: "待付款", toShip: "待发货", toReceive: "待收货", completed: "已完成", coupons: "优惠券", points: "积分", flashSale: "限时秒杀", live: "直播", fitting: "虚拟试衣", settings: "设置", language: "语言", currency: "币种", total: "合计", submitOrder: "提交订单", selectCoupon: "选择优惠券", noCoupon: "不使用优惠券", address: "收货地址", addAddress: "新增地址", confirm: "确认", cancel: "取消", stock: "库存", sales: "销量", detail: "商品详情", recommend: "为你推荐", share: "分享", like: "点赞", chat: "聊天", product: "商品", backHome: "回首页" }) },
    { lang: "en-US", data: t({ home: "Home", categories: "Categories", cart: "Cart", mine: "Me", allProducts: "All Products", favorites: "Favorites", search: "Search", login: "Login", register: "Register", logout: "Logout", addToCart: "Add to Cart", buyNow: "Buy Now", checkout: "Checkout", pay: "Pay Now", paySuccess: "Payment Success", orders: "My Orders", allOrders: "All", pendingPayment: "To Pay", toShip: "To Ship", toReceive: "To Receive", completed: "Completed", coupons: "Coupons", points: "Points", flashSale: "Flash Sale", live: "Live", fitting: "Virtual Try-on", settings: "Settings", language: "Language", currency: "Currency", total: "Total", submitOrder: "Place Order", selectCoupon: "Coupon", noCoupon: "No coupon", address: "Address", addAddress: "New Address", confirm: "OK", cancel: "Cancel", stock: "Stock", sales: "Sales", detail: "Details", recommend: "For You", share: "Share", like: "Like", chat: "Chat", product: "Products", backHome: "Home" }) },
    { lang: "ja-JP", data: t({ home: "ホーム", categories: "カテゴリ", cart: "カート", mine: "マイ", allProducts: "すべての商品", favorites: "お気に入り", search: "検索", login: "ログイン", register: "登録", logout: "ログアウト", addToCart: "カートに入れる", buyNow: "今すぐ購入", checkout: "レジへ", pay: "支払う", paySuccess: "支払い完了", orders: "注文履歴", allOrders: "すべて", pendingPayment: "支払い待ち", toShip: "発送待ち", toReceive: "受け取り待ち", completed: "完了", coupons: "クーポン", points: "ポイント", flashSale: "タイムセール", live: "ライブ配信", fitting: "バーチャル試着", settings: "設定", language: "言語", currency: "通貨", total: "合計", submitOrder: "注文を確定", selectCoupon: "クーポンを選択", noCoupon: "クーポンなし", address: "配送先", addAddress: "住所を追加", confirm: "OK", cancel: "キャンセル", stock: "在庫", sales: "売上", detail: "詳細", recommend: "おすすめ", share: "シェア", like: "いいね", chat: "チャット", product: "商品", backHome: "ホームへ" }) },
    { lang: "ar-SA", data: t({ home: "الرئيسية", categories: "التصنيفات", cart: "السلة", mine: "حسابي", allProducts: "جميع المنتجات", favorites: "المفضلة", search: "بحث", login: "تسجيل الدخول", register: "التسجيل", logout: "تسجيل الخروج", addToCart: "أضف إلى السلة", buyNow: "اشترِ الآن", checkout: "الدفع", pay: "ادفع", paySuccess: "تم الدفع", orders: "طلباتي", allOrders: "الكل", pendingPayment: "بانتظار الدفع", toShip: "بانتظار الشحن", toReceive: "بانتظار الاستلام", completed: "مكتمل", coupons: "الكوبونات", points: "النقاط", flashSale: "تخفيضات خاطفة", live: "بث مباشر", fitting: "تجربة افتراضية", settings: "الإعدادات", language: "اللغة", currency: "العملة", total: "المجموع", submitOrder: "تأكيد الطلب", selectCoupon: "اختر كوبون", noCoupon: "بدون كوبون", address: "العنوان", addAddress: "عنوان جديد", confirm: "موافق", cancel: "إلغاء", stock: "المخزون", sales: "المبيعات", detail: "التفاصيل", recommend: "موصى به", share: "مشاركة", like: "إعجاب", chat: "دردشة", product: "المنتجات", backHome: "الرئيسية" }) },
  ];
...
// 按服务取自有集合种子（微服务数据所有权边界：每个服务只种自己的表）
export function seedFor(collections) {
  const full = seedData();
  const out = {};
  for (const c of collections && collections.length ? collections : Object.keys(full)) {
    out[c] = full[c] || [];
  }
  return out;
}
