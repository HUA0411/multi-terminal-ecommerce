(async () => {
  ...
  return JSON.stringify({ url: location.pathname, hasMall: document.body.innerText.includes("积分商城"), mallItems: document.querySelectorAll(".mall-item").length, balance: (document.querySelector(".p-num")||{}).innerText || "" });
})()